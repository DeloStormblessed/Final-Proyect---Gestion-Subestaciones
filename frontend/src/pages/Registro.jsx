...
export default function Registro() {
  ...
  async function handleSubmit(e) {
    ...
    setCargando(true);
    try {
      // Node fuerza rol OPERARIO en el registro; no se envía ni se muestra selector de rol
      const data = await apiFetch('/api/v1/auth/registro', {
        method: 'POST',
  ...
  return (
    <div style={estilos.pagina}>
      <div style={estilos.tarjeta}>
        ...
        <p style={estilos.subtitulo}>Crea tu cuenta de operario</p>
        ...
        <p style={{ marginTop: '1.25rem', textAlign: 'center', fontSize: '0.875rem', color: '#666' }}>
          ¿Ya tienes cuenta?{' '}
          <Link to="/login" style={{ color: 'var(--color-primario)', fontWeight: 600 }}>
            Inicia sesión
          </Link>
        </p>
      </div>
